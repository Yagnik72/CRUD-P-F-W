        ...
        <div class="cbdb-second-inner-wrap <?php esc_attr_e($cbdb_no_image); ?>">
            <div class="cbdb-blogpost-byline">
                <div class="cbdb-metadatabox">
                    ...
                    $cbdb_posted_by = cbdb_posted_by('', 'By');
                    ...
                    if (isset($cbdb_settings['cbdb_post_date']) && $cbdb_settings['cbdb_post_date']) {
                        echo cbdb_post_date($cbdb_post_date_link, $cbdb_post_date_format, 'On', false, '');
                    }
                ...
                <div class="cbdb-blogpost-text">
                    ...
                    if (isset($cbdb_settings['cbdb_read_more']) && $cbdb_settings['cbdb_read_more']) {
                        $cbdb_read_more = ' <p class="cbdb-link-wrapper"><a href="' . esc_url(get_permalink()) . '" target="' . esc_attr($cbdb_read_more_open_link) . '" class="cbdb-read-more">' . esc_html__($cbdb_read_more_text, CRUD_TEXTDOMAIN) . '</a></p>';
                    }
